(function (exports, PIXI) {
  ...
  class Vector {
    ...
    isInRect(x, y, width, height) {
      return (
        isInRange(this.x, x, x + width) && isInRange(this.y, y, y + height)
      );
    }
    equals(other) {
...
`,
      ...
      if (testCollision(box, r)) {
        collision = Object.assign(
          ...
          ),
          {
            isColliding: {
              rect: Object.assign(
                Object.assign({}, collision.isColliding.rect),
                r.collision.isColliding.rect
              ),
              text: Object.assign(
                Object.assign({}, collision.isColliding.text),
                r.collision.isColliding.text
              ),
              char: Object.assign(
                Object.assign({}, collision.isColliding.char),
  ...
  function testCollision(r1, r2) {
    ...
    return (
      -r2.size.x < ox && ox < r1.size.x && -r2.size.y < oy && oy < r1.size.y
    );
  }
    ...
    if (typeof x === "number") {
      if (typeof y === "number") {
        return print(
          ...
          y,
          Object.assign(
            { isCharacter, isCheckingCollision: true, color: currentColor },
            options
          )
        );
      } else {
  ...
  function init$1() {
    ...
    textImages = textPatterns.map((lp, i) => {
      return Object.assign(Object.assign({}, createLetterImages(lp)), {
  ...
  function defineCharacters(pattern, startLetter) {
    ...
    pattern.forEach((lp, i) => {
      characterImages[index + i] = Object.assign(
        Object.assign({}, createLetterImages(lp)),
  ...
  function mergeDefaultOptions(_options) {
    ...
    if (_options.scale != null) {
      options.scale = Object.assign(
        Object.assign({}, defaultOptions.scale),
        _options.scale
      );
    }
    if (_options.mirror != null) {
      options.mirror = Object.assign(
        Object.assign({}, defaultOptions.mirror),
        _options.mirror
      );
    }
    return options;
...
`;
  ...
  class Random {
    ...
    setSeed(w, x = 123456789, y = 362436069, z = 521288629, loopCount = 32) {
      this.w =
        w != null ? w >>> 0 : Math.floor(Math.random() * 0xffffffff) >>> 0;
      this.x = x >>> 0;
      this.y = y >>> 0;
      this.z = z >>> 0;
  ...
  function init$4(_screen, _pixelSize, _options) {
    ...
    pixelSize = new Vector(
      _pixelSize.x + options$2.padding.x * 2,
      _pixelSize.y + options$2.padding.y * 2
    );
    cursorPos.set(
      screen.offsetLeft + screen.clientWidth * (0.5 - options$2.anchor.x),
      screen.offsetTop + screen.clientWidth * (0.5 - options$2.anchor.y)
    );
  ...
  function update$2() {
    ...
    if (
      options$2.isDebugMode &&
      !pos.isInRect(0, 0, pixelSize.x, pixelSize.y)
    ) {
      updateDebug();
      pos.set(debugPos);
  ...
  var pointer = /*#__PURE__*/ Object.freeze({
    ...
    get isJustPressed() {
      return isJustPressed$1;
    },
    get isJustReleased() {
      return isJustReleased$1;
    },
    init: init$4,
    update: update$2,
  ...
  var input$1 = /*#__PURE__*/ Object.freeze({
    ...
    get isJustPressed() {
      return isJustPressed$2;
    },
    get isJustReleased() {
      return isJustReleased$2;
    },
    init: init$5,
    update: update$3,
  ...
  function init$6(__init, __update, _options) {
    ...
    init$2(
      options$3.viewSize,
      options$3.bodyBackground,
      options$3.viewBackground,
      options$3.isCapturing,
      options$3.isCapturingGameCanvasOnly,
      options$3.captureCanvasScale,
      options$3.theme
    );
    init$5();
    init$1();
  ...
  class Terminal {
    ...
    setState(state) {
      ...
      this.backgroundColorGrid = state.backgroundColorGrid.map((l) =>
        [].concat(l)
      );
  ...
  function addRect(
    ...
    if (
      (theme.name === "shape" || theme.name === "shapeDark") &&
      isDrawing &&
